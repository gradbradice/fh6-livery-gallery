...
internal partial class AuthorCardViewDialog : Window
{
    public AuthorCardViewDialog(AuthorCard card, List<LiveryEntry> allEntries)
    {
        ...
        var authorEntries = allEntries.Where(e => e.AuthorIdentityTagHex is not null && tagSet.Contains(e.AuthorIdentityTagHex)).ToList();
        ...
        if (card.IsAutoGenerated)
        {
            ContentPanel.Children.Add(new TextBlock
            {
                ...
                Foreground = this.GetThemeBrush("AccentBrush"),
            });
        }
